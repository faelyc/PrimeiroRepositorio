...
Original file is located at
    https://colab.research.google.com/drive/1Ud1wy3B-DgkHnBZEPW5v461D0yvfG7Dy
...
# Receba um numero e verifique o dia da semana: Ex 1 ("Domingo")
...
a = float(input("Digite o lado de um triangulo:"))
b = float(input("Digite o lado de um triangulo:"))
c = float(input("Digite o lado de um triangulo:"))
...
# 2. Faça um programa que recebendo um valor inteiro, informe se o número é
...
# 5. Faça um programa em linguagem Python que leia dois números inteiros e
# informe se estes são iguais ou diferentes.
...
usuario = input("Digite M para matutino, V verpertino ou N noturno:")
...
a = int(input("Insira o valor do primeiro produto: R$"))
b = int(input("Insira o valor do segundo produto: R$"))
c = int(input("Insira o valor do terceiro produto: R$"))
...
print("O mais barato é R$ {}" .format(menor))
...
placar = int(input("Informe o número correspondente ao placar do jogo: "))
...
print(f"Seu salário antes do reajuste era de R${salario_anterior:}")
print(f"Seu salário foi aumentado em {percentual_de_aumento}%")
print(f"Seu salário foi aumentado em R${diferenca_entre_salarios:}")
print(f"Seu salário atual é de R${salario_atual:}")